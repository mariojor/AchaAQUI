...
public class EnviarEmailAutenticacao {
	...
	final String username = "sosdiaristasbrasilapp@gmail.com";
	final String password = "ete#2aderico";
	...
	public void enviarEmail(String emailDest, String nomeDest, String emailRemet, String nomeRemet, String assunto,
		...
		try {
			...
			message.setRecipients(Message.RecipientType.TO, InternetAddress.parse("mariojorge.sdei@gmail.com"));
